...
import { TrendingUp, Star, Users, MessageSquare, Crown, Music2 } from "lucide-react";
...
const trendingArtists = [
  {
    ...
    followers: "12.3M",
    growth: "+15%",
    image: "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=100&h=100&fit=crop"
  },
  {
    name: "Taylor Swift",
    genre: "Pop/Country", 
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Connect with music lovers worldwide, discover trending artists, and engage in passionate discussions
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-6">
              ...
              <h3 className="text-2xl font-semibold text-white">Trending Artists</h3>
            </div>
            
            <div className="space-y-4">
              {trendingArtists.map((artist, index) => (
                <Card key={index} className="p-4 gradient-card border-music-gray hover:shadow-hover transition-smooth group cursor-pointer">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        <span className="text-sm text-white">{artist.followers}</span>
          ...
          <div>
            <div className="flex items-center gap-2 mb-6">
              ...
              <h3 className="text-2xl font-semibold text-white">Hot Discussions</h3>
            </div>
          ...
          <div>
            <div className="flex items-center gap-2 mb-6">
              ...
              <h3 className="text-2xl font-semibold text-white">Featured Members</h3>
            </div>
                ...
                <Card key={index} className="p-4 gradient-card border-music-gray hover:shadow-hover transition-smooth group cursor-pointer">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-muted-foreground">{user.favoriteGenre} • {user.followers} followers</p>
                      <Badge variant="secondary" className="mt-1 text-xs bg-music-purple/20 text-music-purple">
                        {user.badge}
                      </Badge>
                    </div>
                  </div>
